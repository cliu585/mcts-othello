...
# Source files
SOURCES = $(SRC_DIR)/othello.c $(SRC_DIR)/mcts.c benchmark.c
OBJECTS = $(OBJ_DIR)/othello.o $(OBJ_DIR)/mcts.o $(OBJ_DIR)/benchmark.o

# Headers
HEADERS = $(INC_DIR)/othello.h $(INC_DIR)/mcts.h
